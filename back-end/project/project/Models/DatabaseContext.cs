...
namespace project.Models
{
    public partial class DatabaseContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PolicyOnEmployee>(entity =>
            {
                entity.HasKey(e => e.RequestId);

                entity.ToTable("PolicyOnEmployee");
                ...
                entity.HasOne(d => d.Company)
                    ...
                    .HasForeignKey(d => d.CompanyId)
                    .HasConstraintName("FK_PolicyOnEmployee_InsuranceCompany");

                entity.HasOne(d => d.Hospital)
                    .WithMany(p => p.PolicyOnEmployees)
                    .HasForeignKey(d => d.HospitalId)
                    .HasConstraintName("FK_PolicyOnEmployee_Hospital");

                entity.HasOne(d => d.Policy)
                    .WithMany(p => p.PolicyOnEmployees)
                    .HasForeignKey(d => d.PolicyId)
                    .HasConstraintName("FK_PolicyOnEmployee_Employee");

                entity.HasOne(d => d.PolicyNavigation)
                    .WithMany(p => p.PolicyOnEmployees)
                    .HasForeignKey(d => d.PolicyId)
                    .HasConstraintName("FK_PolicyOnEmployee_Policy");
            });
